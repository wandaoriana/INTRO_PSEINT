// Ejercicio 1 :
// Diseñar un algoritmo que pida un nombre al usaurio y que  despligue
// en pantalla  el nombre entre asteriscos
// la cantidad de de aserisocs debe ser la mism que  
//caracteres en el nombr eincluido espacios en blanco
